...
const AddVistorForm = (props: FormTypes) => {
  ...
  useEffect(() => {
    if (vistedOffice === 'Other') {
      formData = { ...formData, visitedOffice: otherVistedOffice };
    } else {
      formData = { ...formData, visitedOffice: vistedOffice };
    }
    console.log(formData);
  ...
  useEffect(() => {
    if (vistingPurpose === 'Other') {
      formData = { ...formData, vistingPurpose: otherVistingPurpose };
    } else {
      formData = { ...formData, vistingPurpose: vistingPurpose };
    }
    console.log(formData);
