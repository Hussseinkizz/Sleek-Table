    ...
    <section className="relative flex w-full grow">
      <div className="group relative flex grow items-center justify-between rounded-md">
        ...
        <input
          ...
          onChange={filterData}
          className="relative grow truncate rounded-md border-transparent bg-gray-100 pr-12 text-gray-500 outline-none ring-1 ring-blue-100 transition-colors hover:bg-gray-50 hover:ring-2 hover:ring-blue-100 focus:border-blue-100 focus:outline-none focus:ring-2 focus:ring-blue-100 group-hover:bg-gray-50"
        />
        {/* The Search Icon */}
